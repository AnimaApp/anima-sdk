...
In those cases, the Anima SDK offers the ability to generate code starting from an MHTML payload, which can be generated by the Anima's Website Importer chrome extension.
